...
export const ARTICLES: Article[] = [
  {
    ...
    lead: 'Czy na Twojej fakturze za prąd pojawia się pozycja „opłata za energię bierna”? Nie jesteś sam – wiele firm w Warszawie i całej Polsce płaci setki złotych miesięcznie opłaty, której można uniknąć. W tym artykule wyjaśniamy, czym jest moc bierna, dlaczego generuje dodatkowe koszty i co możesz zrobić, by zmniejszyć rachunki.',
    summaryItems: [
      {
        id: '1',
        name: 'moc bierna to energia, która krąży między urządzeniem a siecią, ale nie wykonuje użytecznej pracy',
      },
      {
        id: '2',
        name: 'zakład energetyczny nalicza opłaty, gdy współczynnik mocy (tzw. cosφ) spada poniżej dopuszczalnego poziomu',
      },
      {
        id: '3',
        name: 'szukaj pozycji „energia bierna pojemnościowa” lub „energia bierna indukcyjna” na fakturze, aby zobaczyć naliczone opłaty',
      },
      {
        id: '4',
        name: 'kompensator mocy biernej może zmniejszyć opłaty za moc bierną niemal do zera',
      },
      {
        id: '5',
        name: 'koszt kompensatora mocy biernej wynosi zwykle od kilku - kilkunastu tys. zł',
      },
      {
        id: '6',
        name: 'wykonaj z nami darmowy audyt, dzięki któremu dopasujemy idealne urządzenie dla Ciebie',
      },
    ],
    tableOfContentItems: [
      {
      ...
      {
        id: '6',
        name: 'Najczęstsze błędy przy kompensacji mocy biernej i jak ich uniknąć',
        link: '#najczestsze-bledy-przy-kompensacji-mocy-biernej-i-jak-ich-uniknac',
      },
      {
        id: '7',
        name: 'Kompensacja mocy biernej w Warszawie – lokalne realizacje i korzyści',
        link: '#kompensacja-mocy-biernej-w-warszawie-lokalne-realizacje-i-korzysci',
      },
      {
        id: '8',
    ...
    sections: [
      ...
      {
        id: '6',
        subHeading: 'Najczęstsze błędy przy kompensacji mocy biernej i jak ich uniknąć',
        paragraph:
      ...
      {
        id: '7',
        subHeading: 'Kompensacja mocy biernej w Warszawie – lokalne realizacje i korzyści',
        paragraph:
  ...
  },
  {
    ...
    summaryItems: [
      {
        id: '1',
        name: 'domowa stacja ładowania (wallbox) ładuje samochód nawet 5 razy szybciej niż zwykłe gniazdko',
      },
      ...
      {
        id: '5',
        name: 'wspólnoty mieszkaniowe muszą wyrazić zgodę na instalację w garażu podziemnym',
      },
    ...
    tableOfContentItems: [
      {
        id: '1',
        name: 'Dlaczego warto mieć własną stację ładowania?',
        link: '#dlaczego-warto-miec-wlasna-stacje-ladowania',
      },
      {
        id: '2',
        name: 'Rodzaje stacji ładowania – którą wybrać?',
        link: '#rodzaje-stacji-ladowania-ktora-wybrac',
      },
      {
        id: '3',
        name: 'Jak wygląda montaż stacji ładowania w Warszawie?',
        link: '#jak-wyglada-montaz-ladowarki-w-warszawie',
      },
      {
        id: '4',
        name: 'Ile kosztuje montaż stacji ładowania?',
        link: '#ile-kosztuje-montaz-stacji-ladowania',
      },
      {
        id: '5',
        name: 'Stacja ładowania w domu jednorodzinnym vs. w bloku',
        link: '#ladowarka-dom-vs-blok',
      },
      {
        id: '6',
        name: 'Najczęstsze błędy przy instalacji stacji ładowania',
        link: '#najczestsze-bledy-przy-instalacji-stacji-ladowania',
      },
      {
        id: '7',
        name: 'Stacje ładowania w Warszawie – przykłady realizacji',
        link: '#stacje-ladowania-warszawa-realizacje',
      },
  ...
  },
  {
    ...
    lead: 'Na wielu fakturach za prąd pojawiają się dodatkowe opłaty za energię bierną – często niezauważane przez właścicieli firm. Wystarczy jednak kilka minut, aby sprawdzić, czy Twoja firma płaci za moc bierną i oszacować możliwe oszczędności. Skorzystaj z kalkulatora i dowiedz się, czy kompensacja mocy biernej może obniżyć Twoje rachunki.',
    summaryItems: [
      {
        id: '1',
        name: 'opłaty za energię bierną pojawiają się najczęściej przy urządzeniach indukcyjnych lub pojemnościowych',
      },
      {
        id: '2',
        name: 'na fakturze szukaj pozycji „energia bierna indukcyjna” lub „energia bierna pojemnościowa”',
      },
      {
        id: '3',
        name: 'wysokie opłaty za moc bierną można zwykle ograniczyć dzięki kompensacji',
      },
      {
        id: '4',
        name: 'skorzystaj z kalkulatora, aby szybko sprawdzić potencjalne oszczędności',
      },
      {
        id: '5',
        name: 'wykonujemy darmowy audyt i dobieramy odpowiedni kompensator mocy biernej',
      },
    ],
    tableOfContentItems: [
      {
